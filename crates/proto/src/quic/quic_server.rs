...
use crate::runtime::{QuinnRuntimeAdapter, RuntimeProvider};
...
impl QuicServer {
    ...
    pub async fn new<P: RuntimeProvider>(
        ...
        Self::with_socket(name_server, server_cert_resolver, provider)
    }
    ...
    pub fn with_socket<P: RuntimeProvider>(
        ...
        Self::with_socket_and_tls_config(local_addr, Arc::new(config), provider)
    }
